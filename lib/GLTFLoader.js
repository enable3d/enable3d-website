    ...
    extendParams(materialParams, materialDef, parser) {
      ...
      if (metallicRoughness) {
        ...
        if (metallicRoughness.baseColorTexture !== undefined) {
          pending.push(
            parser.assignTexture(materialParams, 'map', metallicRoughness.baseColorTexture, THREE.sRGBEncoding)
          )
        }
      }
  ...
  class GLTFMaterialsSheenExtension {
    ...
    extendMaterialParams(materialIndex, materialParams) {
      ...
      if (extension.sheenColorTexture !== undefined) {
        pending.push(
          parser.assignTexture(materialParams, 'sheenColorMap', extension.sheenColorTexture, THREE.sRGBEncoding)
        )
      }
  ...
  class GLTFMaterialsSpecularExtension {
    ...
    extendMaterialParams(materialIndex, materialParams) {
      ...
      if (extension.specularColorTexture !== undefined) {
        pending.push(
          parser.assignTexture(materialParams, 'specularColorMap', extension.specularColorTexture, THREE.sRGBEncoding)
        )
      }
  ...
  class GLTFMaterialsPbrSpecularGlossinessExtension {
    ...
    extendParams(materialParams, materialDef, parser) {
      ...
      if (pbrSpecularGlossiness.diffuseTexture !== undefined) {
        pending.push(
          parser.assignTexture(materialParams, 'map', pbrSpecularGlossiness.diffuseTexture, THREE.sRGBEncoding)
        )
      }
  ...
  class GLTFParser {
    ...
    loadMaterial(materialIndex) {
      ...
      if (materialDef.emissiveTexture !== undefined && materialType !== THREE.MeshBasicMaterial) {
        pending.push(
          parser.assignTexture(materialParams, 'emissiveMap', materialDef.emissiveTexture, THREE.sRGBEncoding)
        )
      }
