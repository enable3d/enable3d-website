...
const main = function() {
  ...
  // floating button css
  const buttonCss = jsx`<link rel="stylesheet" href="/css/floating-action-button.css?ver=1.0.0" />`
  render(buttonCss, document.head, false)
  ...
  render(button, document.body, false)
